    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkerInternalNumber = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Availabilities_WorkingUnits_WorkingUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_WorkingUnits_WorkingUnitId",
                        column: x => x.WorkingUnitId,
                        principalTable: "WorkingUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_WorkingUnitId",
                table: "Availabilities",
                column: "WorkingUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_WorkingUnitId",
                table: "Schedules",
                column: "WorkingUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workers_WorkerInternalNumber",
                table: "Workers",
                column: "WorkerInternalNumber",
                unique: true);
        }
